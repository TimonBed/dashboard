...
interface VirtualSensorGridProps {
  height?: number;
  width?: number;
}

const VirtualSensorGridComponent: React.FC<VirtualSensorGridProps> = () => {
...
export const VirtualSensorGrid = memo(VirtualSensorGridComponent);
